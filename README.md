...
### 🤖 ML 最终结果（2026-05-20 实测）

| 指标 | 数值 | 说明 |
|:-----|:----:|:-----|
| **ETL 管道** | 32s | 4015 有效订单，总营收 257.7 万 |
| **用户画像** | 24s | RFM 630 高价值用户(64.4%)，复购率 77.6% |
| **商品分析** | 19s | 5 品类利润 ~50%，利润率 ~90% |
| **ALS 推荐** | RMSE **0.17** | 11,910 对 User-Product，978 用户 Top-5 |
| **KMeans 聚类** | Silhouette **0.50** | 4 群：高价值核心175人(¥4993) / 低频低消291人(¥1108) |
| **总耗时** | **37s** | 4 个 Spark Job on YARN 全部成功 |

### KMeans 用户分群画像

| 群 | 人数 | 均单数 | 均消费 | 客单价 | 标签 |
|:--:|:----:|:------:|:------:|:------:|:-----|
| 0 | 291 | 2.6 | ¥1,109 | ¥431 | 低频低消 |
| 1 | 175 | 6.9 | ¥4,993 | ¥749 | 🔥 高价值核心 |
| 2 | 194 | 2.7 | ¥2,467 | ¥936 | 低频高客单 |
| 3 | 318 | 4.9 | ¥2,837 | ¥594 | 中频中消 |
